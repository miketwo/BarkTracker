...
stream = pyaud.open(
    ...
    rate=sampleRate,
    # whichever USB port the microphone is plugged in to
...
def sendEmail():
    ...
    # This is what shows up in the content of the email
    text = "Your dog is being noisy at " + \
        currentTime.strftime("%Y-%m-%d %H:%M:%S")
    message = MIMEMultipart()
    message['Subject'] = subject    # The subject of the email
    # Where its being sent from (chosen by user)
